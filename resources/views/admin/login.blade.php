...
<title>Login Admin — GeoIntern PGE</title>
<style>
...
.role-badge{
  display:inline-block;background:#edf7f1;color:#176f3d;
...
<div class="login-card">
  ...
  <div class="panel-left">
    ...
    <div class="tagline">
      <h2>Sistem Manajemen Internship Terpadu</h2>
      <p>Pantau kehadiran, kelola data peserta magang, monitor progres internship, dan unduh laporan dalam satu platform terintegrasi.</p>

      <div class="steps">
        <div class="step-item">
          <div class="step-num">1</div>
          <div class="step-text">Login menggunakan NIP dan password HR</div>
        </div>
        <div class="step-item">
          <div class="step-num">2</div>
          <div class="step-text">Pantau absensi dan data peserta internship</div>
        </div>
        <div class="step-item">
          <div class="step-num">3</div>
          <div class="step-text">Unduh laporan rekap bulanan dalam format PDF</div>
        </div>
      </div>
    </div>
  ...
  <div class="panel-right">
    ...
    <div class="top-link">
      <a href="/mahasiswa/login">Masuk sebagai Intern &rarr;</a>
    </div>

    <div class="role-badge">Admin HR</div>
    <h1>Selamat Datang Kembali</h1>
    <p class="subtitle">Masuk untuk mengakses dashboard HR, mengelola data intern, dan melihat rekap absensi.</p>
    ...
    <p class="footer-note">Akses terbatas hanya untuk Admin HR.</p>
